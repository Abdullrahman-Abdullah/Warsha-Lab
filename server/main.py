...
try:
    ...
    from server.app.services import router as services_router
    from server.app.orders import router as orders_router
    from server.app.subscriptions import router as subs_router
    from server.app.finance import router as finance_router
    from server.app.users import router as users_router
    from server.app.notifications import router as notifications_router
    from server.app.reviews import router as reviews_router
except ImportError:
